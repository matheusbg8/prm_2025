...
# Compila o workspace: colcon build --symlink-install --packages-select prm_2025
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'tartaruga = prm_2025.controle_tartaruga:main',
            'ground_truth_odometry = prm_2025.ground_truth_odometry:main',
            'controle_robo = prm_2025.controle_robo:main',
            'robo_mapper = prm_2025.robo_mapper:main'
        ],
    },
)
